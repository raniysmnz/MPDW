...
Gambar di atas menunjukkan nilai *rounded value* ($\lambda$) optimum sebesar **3,0505** dan pada selang kepercayaan 95% nilai memiliki batas bawah **1,83** dan batas atas **4,3637**. Selang tersebut memuat nilai satu sehingga dapat dikatakan bahwa data bangkitan stasioner dalam ragam.
