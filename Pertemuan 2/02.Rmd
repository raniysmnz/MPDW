...
# input data
```{r}
data <- import("https://raw.githubusercontent.com/raniysmnz/MPDW/main/Data/measures_100.csv")
str(data)
```

## Eksplorasi Data

Sebelum melakukan regresi, akan diperlihatkan *plot time-series* dari Rotor Temperature (PM)
